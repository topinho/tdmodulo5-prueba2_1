...
export var colores = ['aqua', 'fuchsia', 'lime', 'red', 'magenta', 'chartreuse', 'darkturquoise', 'deeppink', 'dodgerblue', 'mediumblue', 'orange', 'yellow', 'green', 'turquoise']
class Cliente {
...
var util = {
    generar_decision:      () => { return (Math.floor(Math.random() * 10) > 4) },
    ...
    generar_color:         () => { return colores[Math.floor(Math.random() * colores.length)]},
    clientes: [
